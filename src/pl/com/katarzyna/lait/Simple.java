...
public class Simple {
	...
	public static void main(String[] args) {
        ...
        log("Obliczona wartoœæ to: " + dodawanie(1,3));
	...
	public static int dodawanie (int c, int d){
		...
		//nieu¿ywane zmienne:
		int wynik = a+b; //zmienne globalne zadeklarowane na samej górze 
	...
	/**
	 * nasz ma³y logger - wyœwietli trochê lepiej ni¿ System.otu.println();
